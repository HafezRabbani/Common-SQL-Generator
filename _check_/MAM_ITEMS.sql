...
,(SELECT LISTAGG(ISI.MSINV_NAM_SUB_INVENTORY_MSINV, ',') WITHIN GROUP(ORDER BY 1)
    FROM (SELECT ISI1.MSINV_NAM_SUB_INVENTORY_MSINV, ISI1.ITEM_ITEM_ID
            FROM MAM.MAM_ITEM_SUB_INVENTORIES ISI1
           WHERE ISI1.FLG_PRIMARY_SUBINVENTORY_MIINV = 1
           GROUP BY ISI1.MSINV_NAM_SUB_INVENTORY_MSINV, ISI1.ITEM_ITEM_ID) ISI
...
,I.LKP_UNIT_TEST_ITEM || CASE
 ...
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_UNIT_TEST_ITEM')
                                              ,I.LKP_UNIT_TEST_ITEM) AS LKP_UNIT_TEST_ITEM_DES
,I.LKP_TYP_ITEM || CASE
 ...
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_TYP_ITEM')
                                              ,I.LKP_TYP_ITEM) AS LKP_TYP_ITEM_DES
...
,I.LKP_COD_SAFETY_ITEM || CASE
 ...
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_COD_SAFETY_ITEM')
                                              ,I.LKP_COD_SAFETY_ITEM) AS LKP_COD_SAFETY_ITEM_DES
,I.LKP_COD_PRDFM_SHP_ITEM
,I.LKP_COD_PRDFM_SHP_ITEM || CASE
   WHEN I.LKP_COD_PRDFM_SHP_ITEM IS NOT NULL THEN
    ': '
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_COD_PRDFM_SHP_ITEM')
                                              ,I.LKP_COD_PRDFM_SHP_ITEM) AS LKP_COD_PRDFM_SHP_ITEM_DES
,I.LKP_TYP_SHP_ITEM
,I.LKP_TYP_SHP_ITEM || CASE
   WHEN I.LKP_TYP_SHP_ITEM IS NOT NULL THEN
    ': '
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('Lkp_Typ_Shp_Item')
                                              ,I.LKP_TYP_SHP_ITEM) AS LKP_TYP_SHP_ITEM_DES
,I.LKP_COD_MANAGMENT_MODEL_ITEM || CASE
   WHEN I.LKP_COD_MANAGMENT_MODEL_ITEM IS NOT NULL THEN
    ': '
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_COD_MANAGMENT_MODEL_ITEM')
                                              ,I.LKP_COD_MANAGMENT_MODEL_ITEM) AS LKP_COD_MANAGMENT_MODEL_IT_DES
,I.LKP_COD_INVENTORY_PLANNING_ITE || CASE
   WHEN I.LKP_COD_INVENTORY_PLANNING_ITE IS NOT NULL THEN
    ': '
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_COD_INVENTORY_PLANNING_ITE')
                                              ,I.LKP_COD_INVENTORY_PLANNING_ITE) AS LKP_COD_INVENTORY_PLANNING_DES
...
,I.LKP_COD_FAMILY_ITEM || CASE
 ...
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_COD_FAMILY_ITEM')
                                              ,I.LKP_COD_FAMILY_ITEM) AS LKP_COD_FAMILY_ITEM_DES
,I.LKP_COD_PLANNING_MAKE_BUY_ITEM || CASE
   WHEN I.LKP_COD_PLANNING_MAKE_BUY_ITEM IS NOT NULL THEN
    ': '
 END ||
 APPS.APP_FND_LOOKUP_PKG.GET_FARSI_MEANING_FUN(UPPER('MAM_ITEMS')
                                              ,UPPER('LKP_COD_PLANNING_MAKE_BUY_ITEM')
                                              ,I.LKP_COD_PLANNING_MAKE_BUY_ITEM) AS LKP_COD_PLANNING_MAKE_BUY_DES
