...
--        JRN.MAM_REQUEST_LINES_JRN
       --
         L
 WHERE 1 = 1
       AND (&LKP_STA_LINE_MREQL IS NULL OR
       L.LKP_STA_LINE_MREQL != &LKP_STA_LINE_MREQL)
       AND
       (&REQUEST_LINE_ID IS NULL OR L.REQUEST_LINE_ID = &REQUEST_LINE_ID)
       AND ( --
